...
var countDownDate = new Date("Feb 8, 2024 00:00:00").getTime();
...
var x = setInterval(function() {
    ...
    document.getElementById("time").innerHTML = "<div class='container'><div class='days block'>"+ days + "<br>天</div>" + "<div class='hours block'>" + hours + "<br>时</div>" + "<div class='minutes block'>" + minutes + "<br>分</div>" + "<div class='seconds block'>" + seconds + "<br>秒</div></div>";
...
console.log('\n\n%c SAVE THE DATE: 8th Feb, 2024!', styles);

console.log('%cYour presence is requested!%c\n\nRegards: Daxin Ruyue', styles1, styles2);
